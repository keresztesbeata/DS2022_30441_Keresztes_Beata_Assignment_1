...
public class ClientController {
    ...
    public ResponseEntity<DeviceDTO> getClientDeviceById(@PathVariable(DEVICE_ID) String deviceId) throws EntityNotFoundException, InvalidAccessException {
        final AccountDTO accountDTO = accountService.getCurrentUserAccount();
    ...
    public ResponseEntity<List<EnergyConsumptionDTO>> getClientEnergyConsumption(@RequestParam @DateTimeFormat(pattern="yyyy-MM-dd") LocalDate date) throws EntityNotFoundException {
        final AccountDTO accountDTO = accountService.getCurrentUserAccount();
    ...
    public ResponseEntity<List<EnergyConsumptionDTO>> getClientDeviceEnergyConsumption(@PathVariable(DEVICE_ID) String deviceId, @RequestParam @DateTimeFormat(pattern="yyyy-MM-dd") LocalDate date) throws EntityNotFoundException, InvalidAccessException {
        final AccountDTO accountDTO = accountService.getCurrentUserAccount();
    ...
    public ResponseEntity<EnergyConsumptionDTO> registerEnergyConsumption(@RequestBody EnergyConsumptionData data) throws EntityNotFoundException {
