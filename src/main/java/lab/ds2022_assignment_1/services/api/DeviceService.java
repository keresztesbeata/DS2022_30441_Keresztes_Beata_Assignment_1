...
public interface DeviceService {
     ...
     * @throws EntityNotFoundException if no user account exists with the given id
     * @throws DuplicateDataException  if the user already has a device registered with the same address
     */
    DeviceDTO addDevice(final String accountId, final DeviceDetailsRequest request) throws EntityNotFoundException, DuplicateDataException;
     ...
     */
    void removeDevice(final String deviceId) throws EntityNotFoundException;
